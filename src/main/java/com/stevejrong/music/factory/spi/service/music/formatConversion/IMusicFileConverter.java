...
public interface IMusicFileConverter {

    /**
     * 验证ffmpeg编解码器环境
     */
    void validateFFmpegCodecEnvironment();
     ...
     * @return
     */
    String convert(String sourceDirectory, String targetDirectory, String sourceFileName, String targetFileName, String sourceFileFormat, String targetFileFormat);
}
