...
public final class FFmpegUtil {
     ...
     * @param audioFileFormatConversionConfig 音频文件转换配置
     */
    public static void convertToFlacMusicFile(String sourceFilePath, String targetFilePath, AudioFileFormatConversionConfig audioFileFormatConversionConfig) {
        /*
        ...
        */
        ...
        try {
            ffmpeg = new FFmpeg(audioFileFormatConversionConfig.getFfmpegFileDirectory());
            ffprobe = new FFprobe(audioFileFormatConversionConfig.getFfprobeFileDirectory());
