 ...
 * 文件类型和文件元数据存储器
 */
public enum FileMetadataPersistResolverEnums implements AbstractEnum {
    // FLAC音频文件元数据存储器
    FLAC_METADATA_PERSIST_RESOLVER {
        @Override
        public String getDesc() {
            return null;
        }

        public String getPersistResolverBeanName() {
            return "flacMetadataPersistResolver";
        }
    ...
    MP3_METADATA_PERSIST_RESOLVER {
        ...
        public String getPersistResolverBeanName() {
            return "mp3MetadataPersistResolver";
        }
    ...
    public static String getResolverBeanNameByEncodingType(String encodingTypeString) {
        for (FileMetadataPersistResolverEnums item : FileMetadataPersistResolverEnums.values()) {

            Class clazz = item.getClass();
            Method getResolverBeanNameMethod = null, encodingTypeMethod = null;
            try {
                getResolverBeanNameMethod = clazz.getMethod("getPersistResolverBeanName");
