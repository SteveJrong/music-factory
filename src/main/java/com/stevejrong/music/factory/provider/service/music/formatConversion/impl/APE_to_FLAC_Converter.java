...
/**
 * APE（Monkey's audio）音频编码格式 转换为 FLAC音频编码格式 音频转换器
 */
public class APE_to_FLAC_Converter extends AbstractMusicFileConverter implements IAudioFileConverter {
    ...
    public String sourceEncodeName() {
        return BaseConstants.AUDIO_ENCODE_APE;
    }
