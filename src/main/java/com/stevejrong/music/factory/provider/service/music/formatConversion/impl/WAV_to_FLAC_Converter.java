...
/**
 * PCM（基于WAV容器）音频编码格式 转换为 FLAC音频编码格式 音频转换器
 * <p>
 * Bug：
 * 1. 转换后专辑封面丢失
 */
public class WAV_to_FLAC_Converter extends AbstractMusicFileConverter implements IAudioFileConverter {
    ...
    public String sourceEncodeName() {
        return BaseConstants.AUDIO_ENCODE_WAV;
    }
