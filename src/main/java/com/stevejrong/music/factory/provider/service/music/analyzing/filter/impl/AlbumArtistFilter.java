...
/**
 * Validator - 音频文件信息中歌曲所属专辑的艺术家过滤器
 *
 * @author Steve Jrong
 * create date: 2021-11-14 9:46 AM
 * @since 1.0
 */
public class AlbumArtistFilter extends AbstractFilter<MusicInfoByFilterBean, FiltratedResultDataBo<Boolean>> {
    ...
    public FiltratedResultDataBo<Boolean> filtrate(MusicInfoByFilterBean criteriaBean) {
        return new FiltratedResultDataBo.Builder<Boolean>(
                !StringUtils.isBlank(criteriaBean.getAlbumArtist())).build();
    }
}