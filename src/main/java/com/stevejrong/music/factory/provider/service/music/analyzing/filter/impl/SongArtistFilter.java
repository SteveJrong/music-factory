...
/**
 * Validator - 音频文件信息中的歌曲艺术家过滤器
 *
 * @author Steve Jrong
 * create date: 2021-11-13 1:47 PM
 * @since 1.0
 */
public class SongArtistFilter extends AbstractFilter<MusicInfoByFilterBean, FiltratedResultDataBo<Boolean>> {
    ...
    public FiltratedResultDataBo<Boolean> filtrate(MusicInfoByFilterBean criteriaBean) {
        return new FiltratedResultDataBo.Builder<Boolean>(
                !StringUtils.isBlank(criteriaBean.getSongArtist())).build();
    }
}