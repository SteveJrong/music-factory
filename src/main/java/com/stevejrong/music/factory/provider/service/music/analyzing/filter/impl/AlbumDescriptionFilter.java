 ...
 * @since 1.0
 */
public class AlbumDescriptionFilter extends AbstractFilter<MusicInfoByFilterBean, FiltratedResultDataBo<Boolean>> {
    ...
    public FiltratedResultDataBo<Boolean> filtrate(MusicInfoByFilterBean criteriaBean) {
        return new FiltratedResultDataBo.Builder<Boolean>(
                !StringUtils.isBlank(criteriaBean.getAlbumDescription())).build();
    }
}