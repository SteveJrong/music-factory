...
/**
 * Validator - 音频文件信息中歌曲内嵌歌词过滤器
 *
 * @author Steve Jrong
 * create date: 2021-11-14 9:45 AM
 * @since 1.0
 */
public class SongLyricsFilter extends AbstractFilter<MusicInfoByFilterBean, FiltratedResultDataBo<Boolean>> {
    ...
    public FiltratedResultDataBo<Boolean> filtrate(MusicInfoByFilterBean criteriaBean) {
        return new FiltratedResultDataBo.Builder<Boolean>(
                !StringUtils.isBlank(criteriaBean.getSongLyrics())).build();
    }
}